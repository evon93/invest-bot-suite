...
**Timestamp**: 2025-12-30T19:33:47.730112
**Mode**: full
**Seed**: 42
**Git HEAD**: 3d63d26b4871

## Results

- Total grid size: 288
- Combinations run: 288
- OK: 288
- Errors: 0
- Duration: 3.08s
...
```bash
python tools/run_calibration_2B.py --mode full --max-combinations 288 --seed 42
```