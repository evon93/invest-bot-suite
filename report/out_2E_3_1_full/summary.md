...
**Timestamp**: 2025-12-28T15:31:07.336595
**Mode**: full
**Seed**: 42
...
- Active scenarios: 72 (33.33%)
- Inactive scenarios: 144 (66.67%)
...
```bash
python tools/run_calibration_2B.py --mode full --max-combinations 216 --seed 42
```